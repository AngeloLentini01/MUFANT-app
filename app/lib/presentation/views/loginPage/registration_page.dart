            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildSocialIcon(
                      'assets/images/loginLogos/facebook_logo.png',
                    ),
                    const SizedBox(width: 16),
                    _buildSocialIcon(
                      'assets/images/loginLogos/google_logo.png',
                    ),
                    const SizedBox(width: 16),
                    _buildSocialIcon('assets/images/loginLogos/apple_logo.png'),
                    const SizedBox(width: 16),
                    _buildSocialIcon(
                      'assets/images/loginLogos/abbonamento_musei_logo.png',
                    ),
                  ],
                ),
