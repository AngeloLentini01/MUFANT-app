...
class AppBarWidget extends StatelessWidget {
  ...
  final bool forceHideBackButton; // New parameter to force hide back button
  ...
  Widget build(BuildContext context) {
    ...
    return SliverAppBar(
      ...
      leading: Navigator.of(context).canPop() && !forceHideBackButton
          ? BackButton(
          ...
          return Container(
            ...
            child: additionalContent != null
                ? Column(
                    ...
                    children: [
                      // Standard AppBar content - fixed height
                      Container(
                      ...
                      // Additional content - constrained height to prevent overflow
                      SizedBox(
                        height: (availableHeight - kToolbarHeight).clamp(
                          0.0,
